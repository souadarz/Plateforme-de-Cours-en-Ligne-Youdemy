...
<div id="categorie_modal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center">
    <div id="add_modal_content" class="flex flex-col w-11/12 md:w-5/12 overflow-y-auto scrollbar-hidden mx-auto mt-10 p-4 bg-gray-200 rounded-sm shadow-lg">
        <div class="flex justify-between">
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">Ajouter Categorie</h1>
            <!-- Close Icon -->
        ...
        <form method="POST" action="" id="category_form" class="mt-[25%] md:px-10 hidden">
            <div class="flex w-full">
                <label for="category_name_input" class="text-gray-900 font-semibold w-1/3">Le nom du categorie :</label>
            ...
            <div class="flex justify-evenly">
                <input type="submit" name="add_modify_category" class="text-gray-100 bg-gray-700 border-2 border-gray-700 hover:bg-gray-900 px-8 py-1 mt-20 mr-6 float-right rounded-sm" value="Enregistrer">
            </div>
        </form>
    </div>
</div>
